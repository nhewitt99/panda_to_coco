...
For now the input dataset image location is hardcoded (sorry) at /mnt/AI_RAID/PANDA
...
CROP_ASPECT = 0.75
MAX_PEOPLE = 30
RETRY_EMPTY_CHANCE = 0.95

output_dataset = '/mnt/AI_RAID/PANDA/panda_coco3'
...
#    global lock
    ...
    image = cv2.imread('/mnt/AI_RAID/PANDA/image_train/' + image_data['file_name'])
